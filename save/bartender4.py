...
class Bartender(MenuDelegate): 
    ...
    def __init__(self):
        ...
        #self.strip = dotstar.DotStar(clockpin,datapin, self.numpixels) #Adafruit_DotStar(self.numpixels, datapin, clockpin)
    ...
    def cycleLights(self):
        ...
        while getattr(t, "do_run", True):
            ...
            for dot in range(randomdots,(randomdots+10)):
                            self.strip.setPixelColor(dot, randomdotcolor)
            self.strip.show()
            time.sleep(0.25)
